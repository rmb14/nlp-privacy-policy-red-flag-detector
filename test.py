...
This privacy notice for [Company Name] (doing business as [Company Short Name]) ("we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:
...
Do we process any sensitive personal information? [We do not process sensitive personal information. / We may process sensitive personal information when necessary with your consent or as otherwise permitted by applicable law. Learn more about sensitive information we process.]
...
How do I exercise my rights? The easiest way to exercise your rights is by filling out our data subject access request form available here: [DSAR Form URL], or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.

Want to learn more about what we do does with any information we collect? Review the privacy notice in full.
...
When we use Google Analytics. We may share your information with Google Analytics to track and analyze the use of the Services. The Google Analytics Advertising Features that we may use include: [List Features]. To opt out of being tracked by Google Analytics across the Services, visit https://tools.google.com/dlpage/gaoptout. You can opt out of Google Analytics Advertising Features through Ads Settings and Ad Settings for mobile apps. Other opt out means include http://optout.networkadvertising.org/ and http://www.networkadvertising.org/mobile-choice. For more information on the privacy practices of Google, please visit the Google Privacy & Terms page.
...
Our servers are located in [Country]. If you are accessing our Services from outside [Country], please be aware that your information may be transferred to, stored, and processed by us in our facilities and by those third parties with whom we may share your personal information (see "WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?" above), in [Country], and other countries.
...
If you have any questions or concerns relating to our Privacy Shield certification, please write to us at the contact details below. We commit to resolving any complaints or disputes about our collection and use of your personal information under the Privacy Shield. [However, if you have an unresolved complaint in connection with our certification, we commit to cooperating with the panel established by [the EU data protection authorities (DPAs)], [the UK Information Commissioner], and [the Swiss Federal Data Protection and Information Commissioner], as applicable, and to comply with the advice given by them in respect of the complaint. See the following list of EU DPAs. / However, if you have an unresolved complaint in connection with our certification, you may contact our independent dispute resolution provider based in the [EU/United States], [Dispute Resolution Provider Name]. Please visit [Dispute Resolution Provider URL] for more information or to file a complaint. These services are provided to you free of charge.]
...
We have not sold or shared any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. / We have sold or shared the following categories of personal information to third parties in the preceding twelve (12) months:
Category A. Identifiers
Category B. Personal information, as defined in the California Customer Records law
Category C. Characteristics of protected classifications under state or federal law
Category D. Commercial information
...
You can ask for the deletion of your personal information. If you ask us to delete your personal information, we will respect your request and delete your personal information, subject to certain exceptions provided by law, such as (but not limited to) the exercise by another consumer of his or her right to free speech, our compliance requirements resulting from a legal ob`
...
To exercise these rights, you can contact us by visiting [DSAR Form URL], by email at [Email Address], by calling toll-free at [Phone Number], by visiting [Contact Form URL], or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.
...
[We sell personal data to third parties or process personal data for targeted advertising. You can opt out from the selling of your personal data, targeted advertising, or profiling by disabling cookies in Cookie Preference Settings.] To submit a request to exercise these rights described above, please email [Email Address] or visit [DSAR Form URL].
...
You may contact us by email at [Email Address] or visit [Contact Form URL].
...
If you are a resident in the European Economic Area or Switzerland, we are the "data controller" of your personal information. We have appointed [EEA Representative Name] to be our representative in the EEA and Switzerland. You can contact them directly regarding our processing of your information, by email at [Email Address], by visiting [EEA Representative URL], by phone at [Phone Number], or by post to:
...
[Swiss Representative Name]
[Street Address]
[City, State ZIP Code]
[Country]
Phone: [Phone Number]
Fax: [Fax Number]
[Swiss Representative URL]

If you are a resident in the United Kingdom, we are the "data controller" of your personal information. We have appointed [UK Representative Name] to be our representative in the UK. You can contact them directly regarding our processing of your information, by email at [Email Address], by visiting [UK Representative URL], by phone at [Phone Number], or by post to:
...
We may share your data with third-party service providers. Please refer to "WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?" section above.
...
"""
resp = requests.post("http://localhost:8000/classify", json={"text": text}).json()
print(resp)
